...
* The most recent major version of Python is **Python 3**, which is commonly used today.
* Python code can be written using:
  ...
  * An **Integrated Development Environment (IDE)** such as:
    ...
    * NetBeans
    * Eclipse
      These IDEs are especially helpful when working with larger Python projects.

---

# **Python Syntax Compared to Other Programming Languages**

Python was designed with **readability** as a core principle and has influences from both **English language structure** and **mathematics**.

Key differences include:

* Python uses **new lines** to end commands, instead of semicolons (`;`)
* Python relies on **indentation (whitespace)** to define code blocks such as:

  * Loops
  * Functions
  * Classes
* Other programming languages typically use **curly braces `{}`** for defining scope
